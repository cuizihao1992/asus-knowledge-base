...
范围：记录 `D:\zhc\90-archive\releases\zhc-companion-lite-release.apk` 的发布产物信息。本次只读元数据和 APK 条目，不移动、不删除、不解压。
...
- 暂保留 `D:\zhc\90-archive\releases\zhc-companion-lite-release.apk`。
